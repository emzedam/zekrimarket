<template>
  <!--   جاری  -->
  <ul class="p-5 p-4-lg" v-if="canceled_pays.length != 0">
    <li v-for="(order, index) in canceled_pays" :key="index">
              ...
              <div class="flex flex-col">
                <div class="flex items-center font-semibold text-gray-700">
                  <div class="relative flex items-center lg:items-start self-stretch">
                    <div class="relative">
                      <div class="flex">
                        <i class="fa-light fa-times-circle text-xl text-gray-400"></i>
                      </div>
                    </div>
                  </div>
                  <div class="mr-2">لغو شده</div>
                </div>
              </div>
              <div>
                <div class="flex">
...
<script setup>
const props = defineProps(["canceled_pays"]);
</script>
