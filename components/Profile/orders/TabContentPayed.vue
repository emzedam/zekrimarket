<template>
  <!--   جاری  -->
  <ul class="p-5 p-4-lg" v-if="paid_ones.length != 0">
    <li v-for="(order, index) in paid_ones" :key="index">
      <div class="flex flex-col lg:gap-y-4">
        ...
        >
          ...
          <div class="py-4 px-4 gap-y-2 hidden lg:grid grid-cols-2">
            <div class="right">
              ...
              <div class="relative rounded-md p-3 pb-4 w-full text-no-wrap pl-0">
                ...
                <div class="relative">
                  <div class="flex flex-row justify-between items-center relative mb-2">
                    <h6 class="font-medium text-green-500">
                      <div class="text-body2-strong">پرداخت شده</div>
                    </h6>
                    <div class="hidden lg:block">
                      <div class="flex flex-row items-center mt-3/2 lg:mt-0 mb-1">
                        <p class="text-gray-500 font-medium">مبلغ پرداختی:</p>
                        <div>
                  ...
                  <div class="bg-gray-200 w-full rounded-lg relative h-2">
                    <div class="rounded-lg relative right-0">
                      <div
                        class="flex justify-center items-center absolute px-2 lg:px-1 top-0 right-0 h-2 rounded-lg bg-green-500 w-[50%]"
                      ></div>
                    </div>
                  </div>
                  <div class="mt-2 lg:hidden">
                    <div class="flex flex-row items-center mt-3/2 lg:mt-0 mb-1">
                      <p class="text-gray-400">مبلغ پرداختی:</p>
                      <div>
                        <div class="flex justify-start items-center mr-1">
...
<script setup>
const props = defineProps(["paid_ones"]);
</script>
