      ...
      <div class="container-x mx-auto">
        ...
        <div class="section-content">
          <div
            ...
            v-if="products && products.selected_products.length != 0"
          >
            <div
              class=""
...
onMounted(async () => {
  ...
  const vitrin_name = route.params.slug.replace(/-/g, " ");
  if (vitrin_name && typeof vitrin_name === "string") {
    const result = await marketStore.get_vitrin_more_products(vitrin_name);
